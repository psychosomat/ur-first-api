# **Глава 2.8: Тестирование созданного API**
**Время изучения:** 1 час
**Цель:** Провести предполетные испытания вашего "космического корабля" - API
...
2. **Трейт `RefreshDatabase` используется для:**
   a) Очистки БД после тестов
   b) Наполнения БД тестовыми данными
   c) Создания структуры БД
